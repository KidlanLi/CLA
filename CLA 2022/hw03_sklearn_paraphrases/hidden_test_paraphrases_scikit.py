...
class Test_paraphrases_scikit(TestCase):
    def setUp(self):
        self.trainpath_small = "hw03_sklearn_paraphrases/unittest-toydata/test.txt"
        self.devpath_small = "hw03_sklearn_paraphrases/unittest-toydata/train.txt"
        self.testpath_small = "hw03_sklearn_paraphrases/unittest-toydata/dev.txt"
        self.trainpath = "data/paraphrases/train.txt"
        #self.devpath = "data/paraphrases/dev.txt"
        #self.testpath = "data/paraphrases/test.txt"

    def test_01_paraphrases_to_dataset_hidden(self):
    ...
    def test_02_read_data_hidden(self):
